...
export const Row = ({ title, movies }: Props) => {
  ...
  const handleClick = (dicrection: string) => {
    setIsMovied(true)
  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      ...
      <div className="group relative md:-ml-2">
        ...
        <ChevronRightIcon
          className={`absolute bottom-0 right-2  top-0 z-40 m-auto h-9 w-9 cursor-pointer opacity-0 transition hover:scale-125 group-hover:opacity-100`}
